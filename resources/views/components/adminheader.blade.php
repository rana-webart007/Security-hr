			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">{{ __('Security Team') }}</div>
					</a>
					<ul>
						<li> <a href="{{ route('admin.guard.list') }}"><i class="bx bx-right-arrow-alt"></i>{{ __('Security Guards') }}</a>
						</li>
						<li> <a href="{{ route('admin.security.list') }}"><i class="bx bx-right-arrow-alt"></i>{{ __('Security Team') }}</a>
						</li>
					</ul>
				</li>
