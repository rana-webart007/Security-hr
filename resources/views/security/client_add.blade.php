    ...
    <div class="page-content">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('security.client.insert') }}" method="post" autocomplete="off"
                            ...
                            <div class="border p-3 rounded">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Building name" value="{{ old('name') }}" />
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="address">Address (Main)</label>
...
function valid() {
    ...
    // else if ($("#info").val() == "") {
    //     $("#addresserror").html("Must be select a area.");
    //     $("#address").focus();
    //     return false;
    // }
}
...
$(function() {
  $("#more_address").click(function(e) {
    e.preventDefault();
    $("#new-address").append('<input type="text" id="address" class="form-control mt-2" placeholder="Address" name="more_address[]">');
  });
});
</script>
