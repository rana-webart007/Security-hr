				...
				<div class="col-md-6 text-end">
						<div class="ctpgbfy mb-3">
						   <div class="dropdown mb-4 d-inline-block me-2">
							...
							<a href="{{ route('security.guard.add') }}" class="mbnbtn"><i class='bx bx-plus me-2' ></i>New Guard</a>
						</div>
					</div>
			  </div>	
							...
							<table class="table align-middle mb-0" id="example2">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">	<a href="{{ route('security.guard.update', ['updateid'=> $val -> id]) }}" class=""><i class="bx bx-cog"></i></a>
												<a href="{{ route('security.guard.delete', ['deleteid'=> $val -> id ]) }}" onclick="return confirm('Do you really want to delete this data?')" class="ms-4"><i class='bx bx-down-arrow-alt'></i></a>
											</div>
										</td>
									</tr>	
                                    @endforeach											
