                        ...
                        <form action="{{ route('security.job.update.success') }}" method="post" autocomplete="off"
                            ...
                            <div class="border p-3 rounded">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="client_id" id="client_id" class="form-control" value="{{ $client->name }}" readonly>
                                ...
                                <!-- -->
                                <div class="mb-3">
                                    <label class="form-label" for="client_id">Job Location</label>
                                    <input type="text" name="job_location" id="job_location" class="form-control" value="{{ $job_address }}" readonly>

                                    <span class="text-danger d-block pt-2" id="job_locationerror"></span>
