							...
							<table class="table align-middle mb-0" id="example2">
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <td>{{ $val -> address }}</td>
										<td>
											<div class="d-flex order-actions">	<a href="{{ route('admin.security.update', ['updateid'=> $val -> id]) }}" class=""><i class="bx bx-cog"></i></a>
												<a href="{{ route('admin.security.delete', ['deleteid'=> $val -> id]) }}" class="ms-4"><i class='bx bx-down-arrow-alt'></i></a>
											</div>
										</td>
									</tr>	
                                    @endforeach											
