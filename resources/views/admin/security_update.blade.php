            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.security.update.insert') }}" method="post" autocomplete="off"
...
function valid() {
    if ($("#name").val() == "") {
        ...
        $("#emailerror").html("Email is a require field.");
        $("#email").focus();
        return false;
    } else if ($("#mobile").val() == "") {
        $("#mobileerror").html("Mobile is a require field.");
        $("#mobile").focus();
        return false;
    } else if ($("#contact_person").val() == "") {
        $("#contact_personerror").html("Contact person is a require field.");
        $("#contact_person").focus();
        return false;
    } else if ($("#phone_no").val() == "") {
        $("#phone_noerror").html("Phone no is a require field.");
        $("#phone_no").focus();
        return false;
    } else if ($("#address").val() == "") {
